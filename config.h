...
#define MODS_TO_NEUTRALIZE { MOD_BIT(KC_LEFT_ALT), MOD_BIT(KC_LEFT_GUI), MOD_BIT(KC_LEFT_ALT)|MOD_BIT(KC_LEFT_SHIFT), MOD_BIT(KC_LEFT_ALT)|MOD_BIT(KC_RIGHT_SHIFT)  }
