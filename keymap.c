...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_JALO] = LAYOUT(
        ...
        KC_J   , KC_ESC,NAV_TAB, KC_G  , KC_D  , KC_V  ,_______, _______,KC_QUOT,KC_BSPC, KC_W  ,KC_SLSH,KC_COLN, KC_Z  ,
                        ...
                        _______,_______,OSL(_NAV2), KC_SPC,LT(_ALTTABCP, MAGIC_L), MAGIC_R,HOME2_E,OSL(_SYM2),_______,_______
  ),
  ...
  [_SYM] = LAYOUT(
        ...
        KC_TILD,KC_EXLM, KC_AT ,KC_HASH,KC_DLR ,KC_CIRC, PLOVER, _______,KC_PERC,KC_AMPR,KC_ASTR,KC_EQL ,KC_PLUS,A_GRAVE,
