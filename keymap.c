...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT(
        ...
        KC_LABK,KC_BSLS,KC_LBRC,KC_RBRC, KC_GRV,KC_RABK,                 O_BRACE,KC_LCBR,KC_LPRN,KC_RPRN,KC_RCBR,KC_DOUBLE_QUOTE,
  ...
  [_NAV] = LAYOUT(
    ...
    [_ALTTABCP] = LAYOUT(
        ...
        _______,C(KC_A),_______,_______,_______,_______,                 _______,_______,_______,_______,_______,_______,
