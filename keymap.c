...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYM] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______, _______,_______,COMPOSE,GUILL_L,GUILL_R, UPDIR ,_______,

                        _______,_______,NAV_UND,_______,_______, _______,_______,_______,_______,_______
  ),
  ...
  [_NAV] = LAYOUT(
    ...
    [_MOUSE] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______, _______,_______,KC_BTN3,KC_WH_D,KC_WH_U,_______,_______,
